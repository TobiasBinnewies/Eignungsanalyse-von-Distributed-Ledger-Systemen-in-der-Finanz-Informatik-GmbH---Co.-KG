...
\todo[color=TODO]{
    Idee mit UTXO-based Token auf Account-based Chain einfügen (bzgw. HD-Wallet fähigen Token) \break
    --> UTXO vermutlich besser, weil weniger Chain Einträge / Auslesungen notwendig sind \break
}
Aufbauend auf der Idee einen neuen Token zu kreieren (s. \ref{datenspeicherung:neuer-token}) ... \todo[color=TODO]{Weiterschreiben}
...
\subsection{Anwendugsbereiche von DLT}
...
%...
\input{Zahlungsverkehr/UseCase/Datenspeicherung.tex}

\input{Zahlungsverkehr/UseCase/Anonymität.tex}

\todo[color=REVIEW]{Wohin mit dem Abschnitt?}
\input{Zahlungsverkehr/UseCase/Oeffentlich-vs-Privates-Netzwerk.tex}

\input{Zahlungsverkehr/UseCase/Transaktionskosten.tex}